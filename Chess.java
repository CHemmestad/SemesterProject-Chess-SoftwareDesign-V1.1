...
public class Chess extends MouseAdapter{
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            paused[0] = paused[0].getScaledInstance(800, 800, Image.SCALE_SMOOTH);
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        JPanel panel = new JPanel()
        {
            ...
            public void paint(Graphics g) {
                ...
                //frame.repaint(); ////DONT DO THIS! YOUR COMPUTER WILL SCREAM!!!!
                if(gamePaused){
        ...
        frame.addMouseListener(new MouseInputListener() {
            ...
            public void mouseDragged(MouseEvent e) {
                if (selectedPiece != null){
                    selectedPiece.xPositionNorm = e.getX()-50;
                    selectedPiece.yPositionNorm = e.getY()-50;
                    frame.repaint();
                }
            }
